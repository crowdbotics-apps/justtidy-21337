"""justtidy_21337 URL Configuration
...
admin.site.site_header = "JustTidy"
admin.site.site_title = "JustTidy Admin Portal"
admin.site.index_title = "JustTidy Admin"

# swagger
api_info = openapi.Info(
    title="JustTidy API",
    default_version="v1",
    description="API documentation for JustTidy App",
)
